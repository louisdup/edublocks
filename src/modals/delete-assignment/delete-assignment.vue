<template>
  <eb-modal @close="modal.onCloseClicked()">
    <eb-modal-header
      :title="modal.getText('delete-assignment')"
      :icon="['far', 'trash']"
      icon-color="red"
      align="center"
    ...
    <eb-modal-content>
      <p class="w-full text-center text-gray-500">
        {{ modal.getText('are-you-sure-you-want-to-delete') }}
      </p>
    </eb-modal-content>
    ...
    <eb-modal-footer align="center">
      ...
      <eb-button
        ...
        @click="modal.onDeleteButtonClicked()"
      />
    </eb-modal-footer>
  </eb-modal>
</template>
...
import { modal } from "./delete-assignment-model";
