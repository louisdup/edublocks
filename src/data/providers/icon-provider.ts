...
library.add(faHome, faCode, faFolderOpen, faFilm, faBookOpen, faUsers, faCommentAlt, faPlus, faEllipsis, faTimes, faTrash, faFile, faArrowRightToArc, faArrowRightFromBracket, faCog, faApple, faGoogle, faMicrosoft);